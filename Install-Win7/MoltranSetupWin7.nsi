...
;  SetDatablockOptimize on     ; - оптимизация блока данных
  Name "Moltran 2.5 for Win7"      ; - название инсталлятора
  OutFile "MoltranSetupWin7.exe"       ; - выходной файл с инсталлятором после выполнения компиляции
  AllowRootDirInstall true   ; - отменяем возможность установки программы в корень
